...
import com.mpyf.lening.activity.adapter.ShangCheng_LeAdapter.ViewHolder;
...
public class ShangCheng_GoldAdapter extends BaseAdapter {

	private Activity activity;
	private List<Map<String, Object>> list;
	private DisplayImageOptions options;

	public ShangCheng_GoldAdapter(Activity activity,
...
//				Setting.apiUrl + jo.getString("picUrl");
				Setting.apiUrl + list.get(position).get("picUrl")
						, holder.iv_goods, options);
