...
public class JingyanZhiAdapter extends BaseAdapter {
	private List<Map<String, Object>> list;
	private Context context;

	public JingyanZhiAdapter(Context context, List<Map<String, Object>> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView tv_jingyanitemzhi_num = (TextView) view
