...
public class JingyandetilActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		init();
		showinfo();
		ListenerServer.setfinish(JingyandetilActivity.this,
	...
	private void showinfo() {
		...
		tv_jingyandetil_time.setText(time.subSequence(0, time.lastIndexOf(":")));
	}
