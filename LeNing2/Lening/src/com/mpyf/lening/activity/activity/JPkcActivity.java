...
public class JPkcActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new Xiaoxibeijing().changetop(JPkcActivity.this, R.color.main);
	...
	private void init() {
		...
		tv_fenleidelio_title.setText("精品课程");
	...
	private void addlistenr() {
			...
			public void onClick(View arg0) {
				...
				if (rl_fenleidelio_seek.getVisibility()==View.INVISIBLE) {
					...
					if(et_fenleidelio_seek.getText().toString().equals("")){
						...
						RmCourseAdapter adapter=new RmCourseAdapter(JPkcActivity.this, list);
						...
						RmCourseAdapter adapter=new RmCourseAdapter(JPkcActivity.this, searchlist);
						lv_fenleidelio_top.setAdapter(adapter);
						Diaoxian.showerror(JPkcActivity.this,"共找到"+searchlist.size()+"项");
						lv_fenleidelio_top.setOnItemClickListener(new OnItemClickListener() {
							...
							public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
									long arg3) {
								// TODO Auto-generated method stub
								Intent intent=new Intent(JPkcActivity.this,NotbuycourseActivity.class);
		...
		et_fenleidelio_seek.addTextChangedListener(new TextWatcher() {
			...
			public boolean onKey(View arg0, int arg1, KeyEvent arg2) {
				...
				if (arg1==KeyEvent.KEYCODE_ENTER){
					if(et_fenleidelio_seek.getText().toString().trim().equals("")){
						RmCourseAdapter adapter=new RmCourseAdapter(JPkcActivity.this, new ArrayList<Map<String,Object>>());
						lv_fenleidelio_top.setAdapter(adapter);
					}else{
searchlist=new ArrayList<Map<String,Object>>();
		...
		dialog.show();
				...
				public void handleMessage(Message msg) {
					...
					if(msg.what==1){
						try {
							...
							Diaoxian.showerror(JPkcActivity.this, e.getMessage());
						}
						lv_fenleidelio_top.setOnItemClickListener(new OnItemClickListener() {
						...
						Diaoxian.showerror(JPkcActivity.this, msg.obj.toString());
					}
				}
			};
			...
			new Thread(){
				...
				public void run() {
					...
					String result=HttpUse.messageget("CourseStudy", "goodsCourse", map);
					try {
