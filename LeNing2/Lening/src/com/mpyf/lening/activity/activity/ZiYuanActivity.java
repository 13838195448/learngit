...
public class ZiYuanActivity extends Activity {

	private LinearLayout ll_ziyuan_back;
	private TextView tv_ziyuan_title;
	private View view;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fragment_comm_resource);
		page = 1;
		init();
	...
	private void init() {
		ll_ziyuan_back = (LinearLayout) findViewById(R.id.ll_ziyuan_back);
		tv_ziyuan_title = (TextView) findViewById(R.id.tv_ziyuan_title);
		tv_ziyuan_title.setText("资源");

		lv_list = (ListView) findViewById(R.id.lv_list);

		rg_btn = (RadioGroup) findViewById(R.id.rg_btn);
		bt_upload = (RadioButton) findViewById(R.id.bt_upload);
		bt_download = (RadioButton) findViewById(R.id.bt_download);
	...
	private void initData(final String s) {
		...
		adapter = new ShareResAdapter(ZiYuanActivity.this, data);
	...
	private void addlistener() {
		// 返回键
		ListenerServer.setfinish(ZiYuanActivity.this, ll_ziyuan_back);
		...
		lv_list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent = new Intent(ZiYuanActivity.this,
